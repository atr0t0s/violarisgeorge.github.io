...
- **Open source** — maintaining [Smallwork](https://github.com/hatchworksvc/smallwork), [Vio](https://github.com/hatchworksvc/vio), and [ObsiTUI](https://github.com/hatchworksvc/obsitui). Smallwork is a PHP AI framework, Vio is an AI-first web framework, and ObsiTUI is a terminal-based Obsidian client with vim keybindings.
